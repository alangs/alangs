...
- 💼 &nbsp; Currently working as Systems Solutions Engineering Hub Lead and Principal Software Engineer at Telespazio Germany GmbH.
...
- 🔧 &nbsp; Eclipse IDE | MS Visual Studio (Code) | Git | Maven | CMake | GitLab | Jenkins | SonarQube | Nexus | Docker | Puppet | JIRA | Confluence | Windows | Linux
- 🖥 &nbsp; Autodesk Maya | Adobe Creative Suite | MagicDraw UML | Latex
- 👌 &nbsp; Certified Scrum Master | Project/Service/Product Management | Leadership | Business Development
